...
This project is licensed under the [Functional Source License, Version 1.1, MIT Future License](LICENSE.md) (FSL-1.1-MIT).

**In short:** you can read, run, modify, and self-host this code for internal use, 
non-commercial research/education, or to build on top of it — you just can't 
repackage it into a competing commercial product or hosted service. Each version 
of the code automatically converts to the fully permissive MIT license two years 
after its release.

See [fsl.software](https://fsl.software) for the full FSL FAQ.
